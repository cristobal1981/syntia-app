  ...
  return (
    <form action={signOut} className={cn(collapsed && 'w-auto')}>
      <button
        ...
        className={cn(
          'flex min-h-10 items-center rounded-md text-sm text-muted-foreground transition-colors hover:bg-sidebar-accent hover:text-foreground focus-visible:ring-2 focus-visible:ring-sidebar-ring focus-visible:outline-none',
