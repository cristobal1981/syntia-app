    ...
    >
      ...
      <div className="relative min-w-0 w-full max-w-md lg:max-w-lg">
        ...
        <input
          ...
          className="h-8 w-full cursor-not-allowed rounded-md border border-border bg-background pr-3 pl-8 text-sm text-muted-foreground placeholder:text-muted-foreground dark:border-border dark:bg-sidebar-accent dark:text-muted-foreground dark:placeholder:text-muted-foreground"
