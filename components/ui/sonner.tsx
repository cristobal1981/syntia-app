  ...
  const toaster = (
    <Sonner
      ...
      toastOptions={{
        ...
        classNames: {
          toast: cn(
            'pointer-events-auto relative flex w-[min(calc(100vw-2rem),22rem)] items-start gap-3 rounded-lg border border-border bg-surface-light p-4 pr-10 text-on-light shadow-lg dark:bg-surface-dark dark:text-on-dark'
          ),
          title:
