export const equipo = {
  ...
  clientes: {
    ...
    bulk: {
      ...
      selectRow: 'Seleccionar cliente',
      selectedCount: '{count} clientes seleccionados',
      assignAdvisorPlaceholder: 'Reasignar asesor a…',
      assignButton: 'Reasignar',
      assigning: 'Reasignando…',
      cancel: 'Cancelar selección',
      assignSuccess: 'Asesor reasignado',
      assignError: 'No se pudo reasignar el asesor',
    },
  },
  nav: {
    users: 'Usuarios',
